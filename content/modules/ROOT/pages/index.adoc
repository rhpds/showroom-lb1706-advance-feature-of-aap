...
NOTE: For your convenience we added the authentication credentials for Ansible Automation Platform to the configuration, so you don't have to manually log in. In most real world scenarios you probably don't want to do this and will not store your password in a clear text configuration file
